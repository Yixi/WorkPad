...
test("Basic test", function() {
    ...
    workpad.dom.delegate(this.container, "a", "click", function(event) {
...
test("Delegation on the body", function() {
    ...
    var delegater = workpad.dom.delegate(document.body, ".delegation-test", "mousedown", function() {
        ok(true, "Callback handler executed");
    });
